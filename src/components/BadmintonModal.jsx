...
export default function BadmintonModal({ onClose }) {
  const room = mansionData.badminton;
  
  return (
    <div className="modal-overlay" onClick={onClose}>
      <motion.div 
        className="modal modal-badminton"
      ...
      >
        ...
        >
          <h2 className="modal-title" style={{ color: 'var(--accent-green)' }}>
