...
export default function TradingModal({ onClose }) {
  const room = mansionData.trading;
  
  return (
    <div className="modal-overlay" onClick={onClose}>
      <motion.div 
        className="modal modal-trading"
      ...
      >
        ...
        >
          <h2 className="modal-title" style={{ color: 'var(--accent-gold)' }}>
